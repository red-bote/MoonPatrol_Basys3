...
#set_property -dict { PACKAGE_PIN T17   IOSTANDARD LVCMOS33 } [get_ports btnR];# unused: jump is wired from JA's up direction instead -- see PORTING_SPEC.md
#set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports btnD];# unused: no 2nd coin/start on this core -- see PORTING_SPEC.md
